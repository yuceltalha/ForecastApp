...
import 'package:untitled1/screens/UserScreens/KullaniciEkle.dart';
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.of(context).pushAndRemoveUntil(
              MaterialPageRoute(builder: (context) => KullaniciEkle()),
                        ...
                        return Card(
                            ...
                            child: ListTile(
                              title: Text(" Kullanıcı Adı: " +
                                  snapshot.data[position].userName.toString()),
                              onTap: () {
                                setState(() {
